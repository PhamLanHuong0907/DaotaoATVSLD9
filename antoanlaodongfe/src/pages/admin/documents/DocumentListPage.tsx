  ...
  return (
    <>
      ...
      <Dialog
        ...
        onClose={() => { if (!streaming || streamDone || streamError) { setUploadDialogOpen(false); resetStreamState(); setUploadTitle(''); setSelectedFileName(''); } }}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogContent>
          {!streaming && (
            <>
              ...
              {selectedFileName && (
                <Box sx={{ mt: 1, px: 1.5, py: 1, bgcolor: 'grey.50', borderRadius: 1, border: '1px solid', borderColor: 'divider', display: 'flex', alignItems: 'center', gap: 1 }}>
